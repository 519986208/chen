...
public class QRCodeMax {
	 ...
	 *            文字
	 */
	public static void CreatQrCode(File codeFile, File bgImgFile, Integer widthHeight, String qrUrl, Integer fontSize,
			Integer imagesX, Integer imagesY, QrCodeText... codeTexts) {
		try {
	...
	public static void main(String[] args) {
		...
		CreatQrCode(QrCodeFile, bgImgFile, widthHeight, url, fontSize, imagesX, imagesY,
				list.toArray(new QrCodeText[] {}));
